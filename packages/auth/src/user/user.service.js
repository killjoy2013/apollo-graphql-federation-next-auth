...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (createUserInput) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepo.create(createUserInput)];
    ...
    UserService.prototype.findAll = function (userName) {
        if (userName === void 0) { userName = null; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(userName !== null)) return [3 /*break*/, 2];
                    ...
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [4 /*yield*/, this.userRepo.find({
                            relations: ['roles']
                        })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        found = _a.sent();
                        return [4 /*yield*/, this.userRepo.save(__assign(__assign({}, found), updateUserInput))];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.userRepo.remove(found)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, id];
